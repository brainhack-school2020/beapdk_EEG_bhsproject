...
This project will aim to investigate the resence of subtypes from the possible associations between different types of measurements, pairing common behavioral and self-reporting measures to electrophysiological (EEG) data, as well as exploring complementary attributes. To do so, a Similarity Network FUsion (SNF) will be used to integrate these different types of data in a non-linear fashion. 
